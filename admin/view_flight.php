                ...
                <table class="table" id="myTable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Flight Company Name</th>
                            <th scope="col">Date</th>
                            <th scope="col">Arrival Time</th>
                            <th scope="col">Departure Time</th>
                            <th scope="col">Destination</th>
                            <th scope="col">Flight Category Type</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                                ...
                                $flightcompname = $row['flight_company_name'];
                                $date = $row['date'];
                                ...
                                while($row1 = mysqli_fetch_assoc($res1)){
                                    $seatno = $row1['seat_no'];
                                    $flightcatid = $row1['flight_category_flight_category_id'];
                                
                                $sql2 = "SELECT * FROM `flight_category` WHERE `flight_category_id` = '$flightcatid' ";
                                $res2 = mysqli_query($conn ,$sql2);
                                while($row2 = mysqli_fetch_assoc($res2)){
                                    $flightcattype = $row2['flight_category_type'];
                                }
                                ...
                                <tr>
                                           <th scope='row' class="text-center"><?php echo $sno; ?></th>
                                            <td class="text-center"><?php echo $flightno ?></td>
                                            <td class="text-center"><?php echo $flighttype ?></td>
                                            <td class="text-center"><?php echo $flightcompname ?></td>
                                            ...
                                            <td class="text-center"><?php echo $flightcattype ?></td>
                                            <td>
                                                <?php echo "
                                                    <a href='flight_edit.php?packid=$id'>"?>
                                                        ...
                                                        <div class='modal-dialog'>
                                                            <div class='modal-content'>
                                                                ...
                                                                <div class='modal-footer'>
                                                                    ...
                                                                    <?php
                                                                    echo "
                                                                    <a href='flight_delete.php?pakid=$id'>" ?>

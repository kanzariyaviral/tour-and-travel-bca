    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Train</h1>
                ...
                <table class="table" id="myTable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Flight Coach Type</th>
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                                ...
                                while($row1 = mysqli_fetch_assoc($res1)){
                                    $seatno = $row1['seat_no'];
                                    $traincatno = $row1['train_coach_category_train_coach_category_no'];
                                    $traincoachno = $row1['train_coach_no'];
                                }
                                $sql2 = "SELECT * FROM `train_coach_category` WHERE `train_coach_category_no` = '$traincatno' ";
                                $res2 = mysqli_query($conn ,$sql2);
                                while($row2 = mysqli_fetch_assoc($res2)){
                                    $traincoachtype = $row2['train_coach_type'];
                                }

                                // $sql3 = "SELECT * FROM `bus_category` WHERE `bus_category_no` ='$buscatno' ";
                                // $res3 = mysqli_query($conn ,$sql2);
                                // while($row3 = mysqli_fetch_assoc($res2)){
                                //     $buscattype = $row3['bus_category_type'];
                                // }
                                ...
                                <tr>
                                           <th scope='row' class="text-center"><?php echo $sno ?></th>
                                            <td class="text-center"><?php echo $trainno ?></td>
                                            <td class="text-center"><?php echo $traintype ?></td>
                                            ...
                                            <td class="text-center"><?php echo $traincoachtype ?></td>
                                            <td class="text-center"><?php echo $seatno ?></td>
                                            <td class="text-center"><?php echo $traincoachno ?></td>
                                            <td>
                                                <?php echo "
                                                    <a href='train_edit.php?packid=$id'>"?>
                                                        ...
                                                        <div class='modal-dialog'>
                                                            <div class='modal-content'>
                                                                ...
                                                                <div class='modal-footer'>
                                                                    ...
                                                                    <?php
                                                                    echo "
                                                                    <a href='train_delete.php?pakid=$id'>" ?>
